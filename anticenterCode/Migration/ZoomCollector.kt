package com.example.multimodalmonitoringintegration.collectors

import android.content.Context
import android.content.Intent
import android.util.Log
import androidx.core.content.ContextCompat
import com.example.multimodalmonitoringintegration.data.PhishingData
import com.example.multimodalmonitoringintegration.data.PhishingDataHub
import com.example.multimodalmonitoringintegration.services.ZoomCapService
...
class ZoomCollector(
    ...
    // ======================================================
    // 🧠 被 ZoomCapService 调用，用于把 RD 检测结果推入 DataHub
    // ======================================================
        ...
        scope.launch {
            try {
                ...
                if (statusUpper == "PHISHING" || statusUpper == "MANIPULATED") {
                    ...
                    Log.i(TAG, "📩 Added to DataHub: ${file.name} -> $resultStatus (${type.uppercase()})")
                } else {
